...
@DEEPAK.on(events.NewMessage(pattern=r"^[?!]purge"))
@is_admin
...
@DEEPAK.on(events.NewMessage(pattern="^[!?/]spurge"))
@is_admin
...
@DEEPAK.on(events.NewMessage(pattern="^[!?/]del$"))
@is_admin
...
@DEEPAK.on(events.callbackquery.CallbackQuery(data="purges"))
async def _(event):
